...
gulp.task('clean.prod', tasks('clean', 'clean.prod'));
gulp.task('clean.app.prod', tasks('clean', 'clean.app.prod'));
...
// --------------
// Build prod.
gulp.task('build.lib.prod', tasks('build.lib.prod'));
gulp.task('build.js.prod', tasks('build.js.prod'));
gulp.task('build.assets.prod', ['build.js.prod'], tasks('build.assets.prod'));
gulp.task('build.index.prod', tasks('build.index.prod'));
gulp.task('build.app.prod', function (done) {
  runSequence('clean.app.prod', 'build.assets.prod', 'build.index.prod', done);
});
gulp.task('build.prod', function (done) {
  runSequence('clean.prod', 'build.lib.prod', 'build.app.prod', done);
});
...
// --------------
// Serve prod.
gulp.task('serve.prod', ['build.prod'], tasks('serve.prod'));
